    ...
    <div class="navbar-start">
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          ...
          <a class="navbar-item" id="A">이달의 추천여행</a>
          <hr class="navbar-divider">
          <a class="navbar-item" id="B">역사 전통 명소</a>
          <a class="navbar-item" id="C">자연 생태 명소</a>
        </div>
      </div>
      <div class="navbar-item has-dropdown is-hoverable">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          <a class="navbar-item" id="F">숙박</a>
          <a class="navbar-item" id="G">쇼핑</a>
        </div>
      </div>
            <div class="navbar-item has-dropdown is-hoverable">
